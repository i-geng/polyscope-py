...
from tetrapolyscope.core import str_to_datatype, str_to_vectortype, str_to_param_coords_type, str_to_param_viz_style, glm3, glm3u, enum_to_str
...
class VolumeGrid(Structure):
    ...
    def add_scalar_quantity(self, name, values, defined_on='nodes', datatype="standard", **scalar_args):
        ...
        if defined_on == 'nodes':
            ...
            if values.shape != self.get_grid_node_dim():
            ...
            if values.shape != self.get_grid_cell_dim():
