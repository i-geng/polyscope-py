...
from tetrapolyscope.core import str_to_datatype, str_to_vectortype, glm3, str_to_enum, enum_to_str
        ...
        if instance is not None:
            ...
            if isinstance(edges, str):
                ...
                if edges not in ['line', 'loop', 'segments']:
                    raise ValueError(
                        "bad edges setting, must either be numpy array, or must be in ['line', 'loop', 'segments'], got " + str(edges))
